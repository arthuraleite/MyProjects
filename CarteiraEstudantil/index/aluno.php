...
?>
    ...
    <div class="container btn_container">
        <button onclick="window.location.href='../forms/cadastra-aluno.php';" class="btn btn-outline-secondary mybutton" style="margin-right: 8px;">Cadastrar</button>
        <button onclick="window.location.href='../actions/atualiza-expirado.php';" class="btn btn-outline-secondary mybutton">Atualizar Expirações</button>
    </div>
