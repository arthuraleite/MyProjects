 ...
 *
 * To rebuild or modify this file with the latest versions of the require_onced
 * software please visit:
 *   https://datatables.net/download/#dt/jq-3.3.1/dt-1.10.18/b-1.5.4/b-flash-1.5.4/sc-1.5.0/sl-1.2.6
 *
 * require_onced libraries:
 *   jQuery 3 3.3.1, DataTables 1.10.18, Buttons 1.5.4, Flash export 1.5.4, Scroller 1.5.0, Select 1.2.6
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/jq-3.3.1/dt-1.10.18/b-1.5.4/b-flash-1.5.4/sc-1.5.0/sl-1.2.6",
...
// buttons so it is require_onced in the Buttons core library
 ...
 * @param {boolean} incExtension require_once the file name extension
 */
...
function _xlsxToStrings( obj ) {
	...
	$.each( obj, function ( name, val ) {
		if ( $.isPlainObject( val ) ) {
			...
			// Fix IE's XML
			if ( _ieExcel ) {
				// IE doesn't require_once the XML declaration
...
Scroller.defaults = /** @lends Scroller.defaults */{
	 ...
	 * require_once the dataTables.scroller.css file for this to be displayed correctly.
	 *  @type     boolean
	 *  @default  false
	 *  @static
	 *  @example
